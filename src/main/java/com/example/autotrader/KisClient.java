...
public class KisClient {
    ...
    private final String orderSellTrId;
    ...
    public KisClient(
            ...
            @Value("${app.kis.order-sell-tr-id}") String orderSellTrId,
        ...
        this.orderSellTrId = orderSellTrId;
        this.cano = cano;
    ...
    public Dtos.OrderResult placeCashBuyOrder(String symbol, int quantity, String ordDvsn, String ordUnpr) {
        return placeCashOrder(Dtos.TradeSide.BUY, symbol, quantity, ordDvsn, ordUnpr, orderBuyTrId);
    }

    public Dtos.OrderResult placeCashSellOrder(String symbol, int quantity, String ordDvsn, String ordUnpr) {
        return placeCashOrder(Dtos.TradeSide.SELL, symbol, quantity, ordDvsn, ordUnpr, orderSellTrId);
    }

    private Dtos.OrderResult placeCashOrder(
            Dtos.TradeSide side,
            String symbol,
            int quantity,
            String ordDvsn,
        ...
        if (trId == null || trId.isBlank()) {
            throw new IllegalStateException(side + " 주문 TR ID가 설정되지 않았습니다.");
        }
        ...
        if (response == null) {
            throw new IllegalStateException(side + " 주문 응답이 비어 있습니다.");
        }
